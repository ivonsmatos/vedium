...
def get_context(context):
    ...
    context.lang = "fr"
    context.canonical_url = "https://vediums.com/fr"
...
def _level_badge(title: str) -> str:
    # Les titres de cours contiennent désormais le code CEFR explicite
    # (ex. "Inglês Online ao Vivo B1+ – Intermediário") — vérifier "B1+"
    # avant "B1" pour ne pas perdre le "+" par correspondance de sous-chaîne.
    BADGES = {
        "B1+": "B1+",
        "A1": "A1",
        "A2": "A2",
