...
def get_context(context):
    ...
    # Precios de Inglés en USD — convertidos por tipo de cambio del catálogo
    # (INTERIM hasta tener precio USD fijo). Fuente única: checkout_options.
    ...
    context.lang = "es"
    context.canonical_url = "https://vediums.com/es"
...
def _level_badge(title: str) -> str:
    # Los títulos de curso ahora traen el código CEFR explícito (ej.
    # "Inglês Online ao Vivo B1+ – Intermediário") — verificar "B1+" antes
    # de "B1" evita perder el "+" por coincidencia de subcadena.
    BADGES = {
        "B1+": "B1+",
        "A1": "A1",
        "A2": "A2",
