...
def _level_badge(title: str) -> str:
    # Kurstitel enthalten jetzt den expliziten CEFR-Code (z. B. "Inglês
    # Online ao Vivo B1+ – Intermediário") — "B1+" vor "B1" prüfen, damit
    # das "+" nicht durch einen Teilstring-Treffer verloren geht.
    BADGES = {
        "B1+": "B1+",
        "A1": "A1",
        "A2": "A2",
