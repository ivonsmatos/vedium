...
def get_context(context):
    ...
    context.title = "Vedium - Live Online Sprachkurse: Englisch und Yoruba"
    context.description = (
        "Lernen Sie Englisch (Niveau A1 bis C1) und Yoruba mit Vedium: Live-Unterricht mit "
        "qualifizierten Lehrkräften, Abschlusszertifikat und echter Lernbegleitung. "
