...
import vedium_core.scripts.migrations.oneshot.seed_ioruba_avancado_catalog as seed_script
import stripe
...
class TestIorubaAvancadoCatalogSeeding:
    ...
    @patch('vedium_core.scripts.migrations.oneshot.seed_ioruba_avancado_catalog.frappe')
    @patch('vedium_core.scripts.migrations.oneshot.seed_ioruba_avancado_catalog.stripe')
