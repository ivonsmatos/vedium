...
import vedium_core.scripts.migrations.oneshot.seed_ingls_c1_catalog as seed_script
import stripe

class TestC1CatalogSeeding:
    
    @patch('vedium_core.scripts.migrations.oneshot.seed_ingls_c1_catalog.frappe')
    @patch('vedium_core.scripts.migrations.oneshot.seed_ingls_c1_catalog.stripe')
    ...
    def test_seeding_reuses_stripe_prices_if_exist(self, mock_stripe, mock_frappe):
        ...
        mock_existing_price.product = "prod_UznRM5sYVlZSuH"
