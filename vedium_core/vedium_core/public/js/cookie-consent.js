 ...
 *
 * Fase C.1.3: Aceitar / Recusar / Gerenciar preferências, com facilidade de
 * acesso equivalente entre Aceitar e Recusar (nenhum dark pattern -- os 2
 * botões principais tem o mesmo estilo visual, "Gerenciar preferências" e
 * secundário mas sempre visível, nunca escondido atrás de mais cliques que
 * os outros dois). Categorias do painel de preferências mapeiam DIRETO pros
 * sinais reais do Consent Mode v2 (nenhuma categoria inventada):
