(function () {
  ...
  var editorialCopy = {
    en: {
      "Verificar certificado": "Verify certificate",
      "Digite o código de verificação impresso no certificado Vedium.": "Enter the verification code printed on the Vedium certificate.",
      "Código de verificação": "Verification code",
      "Verificar": "Verify",
      "Certificado válido.": "Valid certificate.",
      "Certificado não encontrado.": "Certificate not found.",
      "QR Code verificável": "Verifiable QR Code",
      "Registrar interesse": "Register interest",
      "Enviar interesse": "Send interest",
      "Nome": "Name",
      "E-mail": "Email",
      "WhatsApp": "WhatsApp",
      "Conte um pouco do seu objetivo": "Tell us a little about your goal",
      "Recebido. A equipe Vedium vai acompanhar seu interesse.": "Received. The Vedium team will follow up on your interest.",
      "Comunidade por idioma e nível": "Community by language and level",
      "A comunidade Vedium será organizada por idioma, nível e objetivo para prática, desafios e acompanhamento leve entre aulas.": "The Vedium community will be organized by language, level and goal, with practice, challenges and light support between classes.",
      "Indique novos alunos para a Vedium": "Refer new students to Vedium",
      "Idiomas para equipes e empresas": "Language training for teams and companies",
      "Prática diária com voz e shadowing": "Daily voice and shadowing practice",
      "Inglês para entrevista de emprego com treino real de fala": "English for job interviews with real speaking practice",
      "Inglês para programadores que precisam trabalhar com times globais": "English for developers working with global teams",
      "Inglês executivo para reuniões, liderança e negociação": "Executive English for meetings, leadership and negotiation",
      "Aprenda iorubá online com estrutura, pronúncia e contexto cultural": "Learn Yoruba online with structure, pronunciation and cultural context",
      "Comece iorubá do jeito certo: sons, tons, saudações e frases úteis": "Start Yoruba the right way: sounds, tones, greetings and useful phrases",
      "Inglês para viagens com situações reais e prática oral": "Travel English with real situations and speaking practice",
      "Inglês para atendimento ao cliente com foco em suporte, vendas e pós-venda": "English for customer service focused on support, sales and after-sales",
      "Iorubá, cultura e ancestralidade com estudo responsável": "Yoruba, culture and ancestry with responsible study",
      "Português para estrangeiros com foco em vida real no Brasil": "Portuguese for foreigners focused on real life in Brazil",
      "Português executivo para negócios, reuniões e adaptação cultural": "Executive Portuguese for business, meetings and cultural adaptation",
      "Preparação orientada para o Celpe-Bras": "Guided preparation for Celpe-Bras"
    },
    es: {
      "Verificar certificado": "Verificar certificado",
      "Digite o código de verificação impresso no certificado Vedium.": "Introduce el código de verificación impreso en el certificado Vedium.",
      "Código de verificação": "Código de verificación",
      "Verificar": "Verificar",
      "Certificado válido.": "Certificado válido.",
      "Certificado não encontrado.": "Certificado no encontrado.",
      "QR Code verificável": "Código QR verificable",
      "Registrar interesse": "Registrar interés",
      "Enviar interesse": "Enviar interés",
      "Nome": "Nombre",
      "E-mail": "Correo electrónico",
      "Conte um pouco do seu objetivo": "Cuéntanos un poco sobre tu objetivo",
      "Recebido. A equipe Vedium vai acompanhar seu interesse.": "Recibido. El equipo de Vedium hará seguimiento de tu interés.",
      "Comunidade por idioma e nível": "Comunidad por idioma y nivel",
      "Indique novos alunos para a Vedium": "Recomienda nuevos alumnos a Vedium",
      "Idiomas para equipes e empresas": "Idiomas para equipos y empresas",
      "Prática diária com voz e shadowing": "Práctica diaria con voz y shadowing",
      "Inglês para entrevista de emprego com treino real de fala": "Inglés para entrevistas laborales con práctica real de conversación",
      "Inglês para programadores que precisam trabalhar com times globais": "Inglés para programadores que trabajan con equipos globales",
      "Inglês executivo para reuniões, liderança e negociação": "Inglés ejecutivo para reuniones, liderazgo y negociación",
      "Aprenda iorubá online com estrutura, pronúncia e contexto cultural": "Aprende yoruba online con estructura, pronunciación y contexto cultural",
      "Comece iorubá do jeito certo: sons, tons, saudações e frases úteis": "Empieza yoruba correctamente: sonidos, tonos, saludos y frases útiles",
      "Inglês para viagens com situações reais e prática oral": "Inglés para viajes con situaciones reales y práctica oral",
      "Inglês para atendimento ao cliente com foco em suporte, vendas e pós-venda": "Inglés para atención al cliente con foco en soporte, ventas y posventa",
      "Iorubá, cultura e ancestralidade com estudo responsável": "Yoruba, cultura y ancestralidad con estudio responsable",
      "Português para estrangeiros com foco em vida real no Brasil": "Portugués para extranjeros enfocado en la vida real en Brasil",
      "Português executivo para negócios, reuniões e adaptação cultural": "Portugués ejecutivo para negocios, reuniones y adaptación cultural",
      "Preparação orientada para o Celpe-Bras": "Preparación guiada para el Celpe-Bras"
    },
    fr: {
      "Verificar certificado": "Vérifier le certificat",
      "Digite o código de verificação impresso no certificado Vedium.": "Saisissez le code de vérification imprimé sur le certificat Vedium.",
      "Código de verificação": "Code de vérification",
      "Verificar": "Vérifier",
      "Certificado válido.": "Certificat valide.",
      "Certificado não encontrado.": "Certificat introuvable.",
      "QR Code verificável": "QR Code vérifiable",
      "Registrar interesse": "Enregistrer votre intérêt",
      "Enviar interesse": "Envoyer l'intérêt",
      "Nome": "Nom",
      "E-mail": "E-mail",
      "Conte um pouco do seu objetivo": "Parlez-nous un peu de votre objectif",
      "Recebido. A equipe Vedium vai acompanhar seu interesse.": "Reçu. L'équipe Vedium donnera suite à votre intérêt.",
      "Comunidade por idioma e nível": "Communauté par langue et par niveau",
      "Indique novos alunos para a Vedium": "Recommandez de nouveaux étudiants à Vedium",
      "Idiomas para equipes e empresas": "Langues pour équipes et entreprises",
      "Prática diária com voz e shadowing": "Pratique quotidienne avec voix et shadowing",
      "Inglês para entrevista de emprego com treino real de fala": "Anglais pour entretien d'embauche avec vraie pratique orale",
      "Inglês para programadores que precisam trabalhar com times globais": "Anglais pour développeurs travaillant avec des équipes globales",
      "Inglês executivo para reuniões, liderança e negociação": "Anglais exécutif pour réunions, leadership et négociation",
      "Aprenda iorubá online com estrutura, pronúncia e contexto cultural": "Apprenez le yoruba en ligne avec structure, prononciation et contexte culturel",
      "Comece iorubá do jeito certo: sons, tons, saudações e frases úteis": "Commencez le yoruba correctement : sons, tons, salutations et phrases utiles",
      "Inglês para viagens com situações reais e prática oral": "Anglais de voyage avec situations réelles et pratique orale",
      "Inglês para atendimento ao cliente com foco em suporte, vendas e pós-venda": "Anglais pour service client, support, ventes et après-vente",
      "Iorubá, cultura e ancestralidade com estudo responsável": "Yoruba, culture et ancestralité avec une étude responsable",
      "Português para estrangeiros com foco em vida real no Brasil": "Portugais pour étrangers axé sur la vie réelle au Brésil",
      "Português executivo para negócios, reuniões e adaptação cultural": "Portugais exécutif pour affaires, réunions et adaptation culturelle",
      "Preparação orientada para o Celpe-Bras": "Préparation guidée au Celpe-Bras"
    },
    de: {
      "Verificar certificado": "Zertifikat prüfen",
      "Digite o código de verificação impresso no certificado Vedium.": "Geben Sie den auf dem Vedium-Zertifikat gedruckten Prüfcode ein.",
      "Código de verificação": "Prüfcode",
      "Verificar": "Prüfen",
      "Certificado válido.": "Gültiges Zertifikat.",
      "Certificado não encontrado.": "Zertifikat nicht gefunden.",
      "QR Code verificável": "Prüfbarer QR-Code",
      "Registrar interesse": "Interesse registrieren",
      "Enviar interesse": "Interesse senden",
      "Nome": "Name",
      "E-mail": "E-Mail",
      "Conte um pouco do seu objetivo": "Beschreiben Sie kurz Ihr Ziel",
      "Comunidade por idioma e nível": "Community nach Sprache und Niveau",
      "Indique novos alunos para a Vedium": "Neue Lernende an Vedium empfehlen",
      "Idiomas para equipes e empresas": "Sprachtraining für Teams und Unternehmen",
      "Prática diária com voz e shadowing": "Tägliche Praxis mit Stimme und Shadowing",
      "Inglês para entrevista de emprego com treino real de fala": "Englisch für Vorstellungsgespräche mit echter Sprechpraxis",
      "Inglês para programadores que precisam trabalhar com times globais": "Englisch für Entwickler in globalen Teams",
      "Inglês executivo para reuniões, liderança e negociação": "Executive English für Meetings, Führung und Verhandlung",
      "Aprenda iorubá online com estrutura, pronúncia e contexto cultural": "Yoruba online lernen mit Struktur, Aussprache und kulturellem Kontext",
      "Português para estrangeiros com foco em vida real no Brasil": "Portugiesisch für Ausländer mit Fokus auf das reale Leben in Brasilien",
      "Preparação orientada para o Celpe-Bras": "Gezielte Vorbereitung auf Celpe-Bras"
    },
    ru: {
      "Verificar certificado": "Проверить сертификат",
      "Digite o código de verificação impresso no certificado Vedium.": "Введите код проверки, напечатанный на сертификате Vedium.",
      "Código de verificação": "Код проверки",
      "Verificar": "Проверить",
      "Certificado válido.": "Сертификат действителен.",
      "Certificado não encontrado.": "Сертификат не найден.",
      "QR Code verificável": "Проверяемый QR-код",
      "Registrar interesse": "Оставить заявку",
      "Enviar interesse": "Отправить заявку",
      "Nome": "Имя",
      "E-mail": "Эл. почта",
      "Conte um pouco do seu objetivo": "Расскажите немного о вашей цели",
      "Comunidade por idioma e nível": "Сообщество по языку и уровню",
      "Indique novos alunos para a Vedium": "Порекомендуйте новых студентов Vedium",
      "Idiomas para equipes e empresas": "Языки для команд и компаний",
      "Prática diária com voz e shadowing": "Ежедневная практика голоса и shadowing",
      "Inglês para entrevista de emprego com treino real de fala": "Английский для собеседований с реальной разговорной практикой",
      "Inglês para programadores que precisam trabalhar com times globais": "Английский для программистов в глобальных командах",
      "Inglês executivo para reuniões, liderança e negociação": "Деловой английский для встреч, лидерства и переговоров",
      "Português para estrangeiros com foco em vida real no Brasil": "Португальский для иностранцев для реальной жизни в Бразилии",
      "Preparação orientada para o Celpe-Bras": "Подготовка к Celpe-Bras с сопровождением"
    },
    "zh-CN": {
      "Verificar certificado": "验证证书",
      "Digite o código de verificação impresso no certificado Vedium.": "请输入 Vedium 证书上打印的验证码。",
      "Código de verificação": "验证码",
      "Verificar": "验证",
      "Certificado válido.": "证书有效。",
      "Certificado não encontrado.": "未找到证书。",
      "QR Code verificável": "可验证二维码",
      "Registrar interesse": "登记意向",
      "Enviar interesse": "发送意向",
      "Nome": "姓名",
      "E-mail": "电子邮箱",
      "Conte um pouco do seu objetivo": "简单说明你的目标",
      "Comunidade por idioma e nível": "按语言和级别划分的社区",
      "Indique novos alunos para a Vedium": "向 Vedium 推荐新学员",
      "Idiomas para equipes e empresas": "面向团队和企业的语言培训",
      "Prática diária com voz e shadowing": "每日语音与跟读练习",
      "Inglês para entrevista de emprego com treino real de fala": "面试英语，真实口语训练",
      "Inglês para programadores que precisam trabalhar com times globais": "面向全球团队开发者的英语",
      "Inglês executivo para reuniões, liderança e negociação": "面向会议、领导力和谈判的商务英语",
      "Português para estrangeiros com foco em vida real no Brasil": "面向外国人的葡萄牙语，聚焦巴西真实生活",
      "Preparação orientada para o Celpe-Bras": "Celpe-Bras 指导备考"
    }
  };

  Object.keys(editorialCopy).forEach(function (lang) {
    localeCopy[lang] = Object.assign(localeCopy[lang] || {}, editorialCopy[lang]);
  });
