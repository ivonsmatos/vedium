...
def execute():
    ...
    monthly_prices = [
        {"classes": 1, "amount": 320.00, "subtotal": 320.00, "unit_amount": 320.00, "discount": 0, "price_id": "price_1TznqQJu78f2k3L0Fb5fttzd", "lookup_key": f"{course_name}_monthly", "create": False},
        {"classes": 2, "amount": 576.00, "subtotal": 640.00, "unit_amount": 576.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_2x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Mensal — 2 aulas/semana"},
        {"classes": 3, "amount": 864.00, "subtotal": 960.00, "unit_amount": 864.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_3x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Mensal — 3 aulas/semana"},
        {"classes": 4, "amount": 1152.00, "subtotal": 1280.00, "unit_amount": 1152.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_4x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Mensal — 4 aulas/semana"},
        {"classes": 5, "amount": 1440.00, "subtotal": 1600.00, "unit_amount": 1440.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_5x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Mensal — 5 aulas/semana"},
    ]

    # Lista de preços anuais
    annual_prices = [
        {"classes": 1, "amount": 266.66, "subtotal": 266.66, "unit_amount": 266.66, "discount": 0, "price_id": "price_1TznqRJu78f2k3L0MHCcPp2j", "lookup_key": f"{course_name}_annual", "create": False},
        {"classes": 2, "amount": 479.99, "subtotal": 533.32, "unit_amount": 479.99, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_2x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Anual — 2 aulas/semana"},
        {"classes": 3, "amount": 719.98, "subtotal": 799.98, "unit_amount": 719.98, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_3x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Anual — 3 aulas/semana"},
        {"classes": 4, "amount": 959.98, "subtotal": 1066.64, "unit_amount": 959.98, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_4x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Anual — 4 aulas/semana"},
        {"classes": 5, "amount": 1199.97, "subtotal": 1333.30, "unit_amount": 1199.97, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_5x", "create": True, "nickname": "Vedium — Iorubá Intermediário — Anual — 5 aulas/semana"},
    ]
...
def _create_price_if_not_exists(course_name, period, product_id, p_data):
    ...
    if existing:
        ...
        frappe.db.set_value("Vedium Course Price", existing, "stripe_validated", 1 if stripe_price_id else 0)
        frappe.db.commit()
    ...
    doc = frappe.get_doc({
        ...
        "course": course_name,
        "commercial_name": f"Iorubá Intermediário ({p_data['classes']}x na semana)",
        ...
        "stripe_validated": 1 if stripe_price_id else 0,
    })
