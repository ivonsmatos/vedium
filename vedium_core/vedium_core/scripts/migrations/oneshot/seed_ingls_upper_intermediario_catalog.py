...
def execute():
    ...
    monthly_prices = [
        {"classes": 1, "amount": 240.00, "subtotal": 240.00, "unit_amount": 240.00, "discount": 0, "price_id": "price_1TznqTJu78f2k3L00HZSakNK", "lookup_key": f"{course_name}_monthly", "create": False},
        {"classes": 2, "amount": 432.00, "subtotal": 480.00, "unit_amount": 432.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_2x", "create": True, "nickname": "Vedium — Inglês B2 — Mensal — 2 aulas/semana"},
        {"classes": 3, "amount": 648.00, "subtotal": 720.00, "unit_amount": 648.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_3x", "create": True, "nickname": "Vedium — Inglês B2 — Mensal — 3 aulas/semana"},
        {"classes": 4, "amount": 864.00, "subtotal": 960.00, "unit_amount": 864.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_4x", "create": True, "nickname": "Vedium — Inglês B2 — Mensal — 4 aulas/semana"},
        {"classes": 5, "amount": 1080.00, "subtotal": 1200.00, "unit_amount": 1080.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_monthly_5x", "create": True, "nickname": "Vedium — Inglês B2 — Mensal — 5 aulas/semana"},
    ]

    # Lista de preços anuais
    annual_prices = [
        {"classes": 1, "amount": 200.00, "subtotal": 200.00, "unit_amount": 200.00, "discount": 0, "price_id": "price_1TznqUJu78f2k3L0bP8aEc1x", "lookup_key": f"{course_name}_annual", "create": False},
        {"classes": 2, "amount": 360.00, "subtotal": 400.00, "unit_amount": 360.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_2x", "create": True, "nickname": "Vedium — Inglês B2 — Anual — 2 aulas/semana"},
        {"classes": 3, "amount": 540.00, "subtotal": 600.00, "unit_amount": 540.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_3x", "create": True, "nickname": "Vedium — Inglês B2 — Anual — 3 aulas/semana"},
        {"classes": 4, "amount": 720.00, "subtotal": 800.00, "unit_amount": 720.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_4x", "create": True, "nickname": "Vedium — Inglês B2 — Anual — 4 aulas/semana"},
        {"classes": 5, "amount": 900.00, "subtotal": 1000.00, "unit_amount": 900.00, "discount": 10, "price_id": None, "lookup_key": f"{course_name}_annual_5x", "create": True, "nickname": "Vedium — Inglês B2 — Anual — 5 aulas/semana"},
    ]
...
def _create_price_if_not_exists(course_name, period, product_id, p_data):
    ...
    doc = frappe.get_doc({
        ...
        "course": course_name,
        "commercial_name": f"Inglês Online ao Vivo B2 – Intermediário Avançado ({p_data['classes']}x na semana)",
