// QA visual: screenshots full-page e por seção de /curso-de-ioruba-online
...
// Professor removido (2026-08-29, decisão de escopo): nenhum curso exibe
// nome de professor. main > * agora tem 11 filhos (era 12).
const GROUPS_1440 = [
  { name: "01-header-hero", startIndex: 0, endIndex: 2, fromTop: true },
  { name: "02-estudo-de-ioruba", startIndex: 3, endIndex: 3 },
  { name: "03-live", startIndex: 4, endIndex: 4 },
  { name: "04-percurso", startIndex: 5, endIndex: 5 },
  { name: "05-idioma-cultura", startIndex: 6, endIndex: 6 },
  { name: "06-conhecimento", startIndex: 7, endIndex: 7 },
...
for (const viewport of VIEWPORTS) {
  ...
  await page.screenshot({ path: `${OUT_DIR}/ioruba-${viewport.name}-full.png`, fullPage: true });
  ...
  for (const group of viewport.groups) {
    ...
    await page.screenshot({
      path: `${OUT_DIR}/ioruba-${viewport.name}-${group.name}.png`,
      fullPage: true,
